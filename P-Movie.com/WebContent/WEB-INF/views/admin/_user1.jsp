	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="block-body text-right mb-3">
						...
						<div role="document" class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<strong id="exampleModalLabel" class="modal-title">Search
										Modal</strong>
								...
								<div class="modal-body">
									...
									<form name="frmSearch" action="${userPage }" method="get">
										<div class="form-group">
											<label>Username</label> <input type="text" name="keyword"
												ng-model="keyword" required class="form-control">
											<div ng-show="frmSearch.keyword.$invalid"
												class="badge badge-danger">Keyword not null</div>
												
										</div>

										<div class="form-group">
											<button class="btn btn-primary"
												formaction="${userPage }/search" ng-disabled="frmSearch.$invalid">Search</button>
										</div>
									</form>
								</div>
							</div>
			...
			<div class="col-lg-12">
				<div class="block">
					...
					<div class="block-body">
						<div class="row">
							<div class="col-md-4">
								<img alt="avatar" class="avatar-user" src="/P-Movie.com/photo/avatar/${user.avatar }" width="100%" >
							</div>
							<div class="col-md-8">
								<form ng-controller="user" name="frmUser" action="${userPage }" method="post"
